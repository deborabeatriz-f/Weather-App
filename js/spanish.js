...
function getForecast(coordinates) {
  ...
  let apiUrl = `https://api.openweathermap.org/data/2.5/onecall?lat=${coordinates.lat}&lon=${coordinates.lon}&appid=${apiKey}&lang=sp&units=metric`;
...
function search(city) {
  let apiKey = "4620cdf98d4514231f7fef13652555c7";
  let apiUrl = `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=${apiKey}&lang=sp&units=metric`;
